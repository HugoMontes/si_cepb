      ...
      <div class="box ">
        ...
        <div class="box-body">
          <div class="grafic">
            ...
            <a href="<?php echo BASE_URL; ?>controller/DescargarDispatcher.php?action=pdf&controlador=internacionales" class="btn btn-danger btn-descargar" role="button"><i class="fa fa-file-pdf-o fa-lg"></i> Descargar en PDF</a>
            <a href="<?php echo BASE_URL; ?>controller/DescargarDispatcher.php?action=excel&controlador=internacionales" class="btn btn-success btn-descargar" role="button"><i class="fa fa-file-excel-o fa-lg"></i> Descargar EXCEL</a>
          </div>
        </div>
        <!-- /.box-body -->
