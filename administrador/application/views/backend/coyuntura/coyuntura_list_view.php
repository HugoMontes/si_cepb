...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
  	<form id="form-estadistico" action="<?php echo base_url('index.php/backend/coyuntura/'); ?>" class="form-horizontal">
...
<div id="pnl-editar-indicador" class="panel panel-primary" style="display: none;">
  ...
  <form action="<?php echo base_url('index.php/backend/coyuntura/guardar'); ?>" method="post">
	  <div class="panel-body">
		  <div class="form-group">
		  ...
		  <div style="text-align: right;">
		  	<a id="btn-download-excel" href="<?php echo base_url('index.php/backend/coyuntura/download/excel'); ?>" class="btn btn btn-info"><span class="glyphicon glyphicon-download-alt"></span> Descargar archivo excel</a>
	  ...
	  <div class="panel-footer" style="text-align: right;">
	  	...
	  	<a href="<?php base_url('backend/coyuntura'); ?>" class="btn btn-default">Cancelar</a>
...
<div class="modal fade" id="mdl-upload-excel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('index.php/backend/coyuntura/upload/excel');?>" enctype="multipart/form-data" method="post">
	      <div class="modal-body">
			  <div class="form-group">
